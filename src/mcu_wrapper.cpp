#include <SPI.h>
#include "bcc_c.h" // Battery Cell Controller (BCC) library
...
/// @brief SPI transfer in TPL mode: transfers data via SPI, 
/// waits for reception complete, then logs/stores received data.
/// @param drvInstance 
/// @param transBuf 
/// @param recvBuf 
/// @param recvTrCnt 
